...
**A les pràctiques has treballat amb una màquina real (amfitriona) i diverses màquines virtuals. Explica:**
...
**Després de fer una prova de rendiment amb Novabench en una màquina virtual Windows: Explica per què és important fer aquestes proves abans d’afegir més màquines virtuals al mateix ordinador amfitrió i posa un exemple de problema que es podria evitar.**   
